  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0dch5p7z7np61mc78afrl1ib44h9mikw69i4368qaa6azh696jna"))))
    (build-system pyproject-build-system)
    (arguments
     (list
          ...
          (add-after 'unpack 'substitute-opencv-paths
            (lambda* (#:key inputs #:allow-other-keys)
              (substitute* (list "src/filter/facebl0r/facebl0r.cpp"
                ...
                (("/usr/share/opencv")
                 (string-append (assoc-ref inputs "opencv") "/share/opencv4"))))))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1byj9j5pzby6gx4kh4jzvd1xg3wpsx3hijpml4cxyqan99vvndd8"))))
    (build-system qt-build-system)
    (arguments
     (list
