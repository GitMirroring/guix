  ...
  (package
    ...
    (source
     (origin
       ...
       (modules '((guix build utils)))
       (snippet #~(delete-all-but "." "logging"))))
    (build-system go-build-system)
    (arguments
     (list
  ...
  (package
    ...
    (source
     (origin
       ...
       (modules '((guix build utils)))
       (snippet #~(delete-all-but "." "longrunning"))))
    (build-system go-build-system)
    (arguments
     (list
  ...
  (package
    ...
    (source
     (origin
       ...
       (modules '((guix build utils)))
       (snippet #~(delete-all-but "." "monitoring"))))
    (build-system go-build-system)
    (arguments
     (list
      #:skip-build? #t
  ...
  (package
    ...
    (source
     (origin
       ...
       (modules '((guix build utils)))
       (snippet #~(delete-all-but "." "security"))))
    (build-system go-build-system)
    (arguments
     (list
      #:skip-build? #t
  ...
  (package
    ...
    (source
     (origin
       ...
       (modules '((guix build utils)))
       (snippet #~(delete-all-but "." "spanner"))))
    (build-system go-build-system)
    (arguments
     (list
  ...
  (package
    ...
    (source
     (origin
       ...
       (modules '((guix build utils)))
       (snippet #~(delete-all-but "." "credentials"))))
    (build-system go-build-system)
    (arguments
     (list
  ...
  (package
    ...
    (source
     (origin
       ...
       (modules '((guix build utils)))
       (snippet #~(delete-all-but "." "internal"))))
    (build-system go-build-system)
    (arguments
     (list
  ...
  (package
    ...
    (source
     (origin
       ...
       (modules '((guix build utils)))
       (snippet #~(delete-all-but "." "parseutil"))))
    (build-system go-build-system)
    (arguments
     (list
...
(define-public go-github-com-kankanreno-go-snowflake
  (package
    (name "go-github-com-kankanreno-go-snowflake")
    (version "1.2.0")
    (source
     (origin
       (method git-fetch)
       (uri (git-reference
              (url "https://github.com/kankanreno/go-snowflake")
              (commit (string-append "v" version))))
       (file-name (git-file-name name version))
       (sha256
        (base32 "1c78rqgyvgypk9crq5mfracmcmxj7611r17d483abhd398cg2pgg"))))
    (build-system go-build-system)
    (arguments
     (list
      #:tests? #f        ;timed out or panic
      #:import-path "github.com/kankanreno/go-snowflake"))
    ...
    (description
     "Package snowflake is a network service for generating unique ID numbers
at high scale with some simple guarantees.  The ID generated by the snowflake
algorithm is not guaranteed to be unique.  For example, when two different
requests enter the same machine at the same time, and the sequence generated
by the node is the same, the generated ID will be duplicated.  It's an
alternative fork of @url{https://github.com/godruoyi/go-snowflake}.")
    (license license:expat)))
  ...
  (package
    ...
    (source
     (origin
       ...
       (modules '((guix build utils)))
       (snippet #~(delete-all-but "." "examples"))))
    (build-system go-build-system)
    (arguments
     (list
      #:skip-build? #t
